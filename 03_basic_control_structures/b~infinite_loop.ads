...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_infinite_loop" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1b41f856#;
   pragma Export (C, u00001, "infinite_loopB");
   ...
   u00090 : constant Version_32 := 16#e31b7c4e#;
