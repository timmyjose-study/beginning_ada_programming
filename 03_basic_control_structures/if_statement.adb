...
begin
  if Int1 = Int2 or Int1 > Int2 then
    Ada.Text_IO.Put_Line ("Int1 is the same or greater than Int2");
  elsif Int1 = Int3 and Int2 <= Int1 then
    Ada.Text_IO.Put_Line ("Int and Int3 are the same");
  else
    Ada.Text_IO.Put_Line ("In the else part of the if statement");
  end if;
  ...
  if Int3 in 90 .. 100 then
    ...
    Ada.Text_IO.Put_Line ("Int2 is not between 90 and 100");
  end if;
end If_Statement;