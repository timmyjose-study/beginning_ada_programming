package body Air_Vehicle.Hotair_Balloon is
  ...
  begin
    ...
    HAB.Balloon_Propane_Volume := B_Propane_Volume;
  ...
  begin
    ...
    Ada.Text_IO.Put_Line ("Balloon volume of vehicle: " & Positive'Image (HAB.Height));
    Ada.Text_IO.Put ("Max Propane volume of vehicle: ");
    Ada.Float_Text_IO.Put (HAB.Balloon_Propane_Volume, Aft => 2, Exp => 0);
    Ada.Text_IO.New_Line;
