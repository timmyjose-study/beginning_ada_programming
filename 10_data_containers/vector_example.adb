...
procedure Vector_Example is
  ...
  procedure Populate_Vector (Vec: in out Software_Companies_Tracker.Vector) is
  begin
    ...
    Vec.Append (New_Item => Ada.Strings.Unbounded.To_Unbounded_String ("Apple"));
    vec.Append (New_Item => Ada.Strings.Unbounded.To_Unbounded_String ("Twitter"));
    vec.Append (New_Item => Ada.Strings.Unbounded.To_Unbounded_String ("Yelp"));
    vec.Append (New_Item => Ada.Strings.Unbounded.To_Unbounded_String ("Tesla"));
    vec.Append (New_Item => Ada.Strings.Unbounded.To_Unbounded_String ("Uber"));
  end Populate_Vector;
begin
  ...
  for Idx in 1 .. Software_Companies.Length loop
    Ada.Text_IO.Unbounded_IO.Put_Line (Software_Companies.Element (Index => Positive (Idx)));
  end loop;
