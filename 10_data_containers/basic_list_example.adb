...
procedure Basic_List_Example is
  package Number_List is new Ada.Containers.Doubly_Linked_Lists (Element_Type => Integer);
  ...
  begin
    loop
      declare
        Number: Integer;
      begin
        Ada.Text_IO.Put ("Enter your choice (0 - Quit, 1 - Append at end 2 - Append at front: )");
        ...
        case Command is
          when 1 => List.Append (New_Item => Number);
          when 2 => List.Prepend (New_Item => Number);
  ...
  begin
    -- "this" is implicit
    Ada.Text_IO.Put_Line ("Item => " & Integer'Image (Number_List.Element (Position)));
  end Display_List;
begin
