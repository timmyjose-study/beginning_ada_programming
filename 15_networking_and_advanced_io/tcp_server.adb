...
procedure TCP_Server is
   ...
   Server_Data_Out : constant String := "I like cake!";
   Server_Data_In  : String          := "          ";
begin
   ...
   Ada.Text_IO.Put_Line ("Server started on 127.0.0.1:50000");
   ...
   loop
      ...
      begin
         loop
            String'Read (Channel, Server_Data_In);
            String'Write (Channel, Server_Data_Out);
         end loop;
      exception
